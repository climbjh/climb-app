...
export class Contact extends RestObject {
    ...
    @sField({ apiName: 'Prequalified__c', createable: true, updateable: true, required: true, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.BOOLEAN, salesforceLabel: 'Prequalified?', externalId: false })
    public prequalified?: boolean | null;
    @sField({ apiName: 'Loan_Amount__c', createable: true, updateable: true, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.CURRENCY, salesforceLabel: 'Loan Amount', externalId: false })
    public loanAmount?: number | null;
    @sField({ apiName: 'Stage__c', createable: true, updateable: true, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.PICKLIST, salesforceLabel: 'Stage', externalId: false })
    ...
    @sField({ apiName: 'Account_Number__c', createable: false, updateable: false, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.STRING, salesforceLabel: 'Account Number', externalId: false })
    ...
    constructor(fields?: ContactFields, restInstance?: Rest) {
        ...
        this.prequalified = void 0;
        this.loanAmount = void 0;
        this.stage = void 0;
