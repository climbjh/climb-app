...
export class Account extends RestObject {
    ...
    @sField({ apiName: 'Data_Quality_Description__c', createable: false, updateable: false, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.STRING, salesforceLabel: 'Data Quality Description', externalId: false })
    public readonly dataQualityDescription?: string | null;
    @sField({ apiName: 'Data_Quality_Score__c', createable: false, updateable: false, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.DOUBLE, salesforceLabel: 'Data Quality Score', externalId: false })
    public readonly dataQualityScore?: number | null;
    @sField({ apiName: 'Sum_of_Opportunities__c', createable: false, updateable: false, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.CURRENCY, salesforceLabel: 'Sum of Opportunities', externalId: false })
    public readonly sumOfOpportunities?: number | null;
    @sField({ apiName: 'Potential_Value__c', createable: false, updateable: false, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.CURRENCY, salesforceLabel: 'Potential Value', externalId: false })
    public readonly potentialValue?: number | null;
    @sField({ apiName: 'Match_Billing_Address__c', createable: true, updateable: true, required: true, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.BOOLEAN, salesforceLabel: 'Match Billing Address', externalId: false })
    public matchBillingAddress?: boolean | null;
    ...
    @sField({ apiName: 'Founding_Date__c', createable: true, updateable: true, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.DATE, salesforceLabel: 'Founding Date', externalId: false })
    public foundingDate?: CalendarDate | null;
    ...
    @sField({ apiName: 'Top_Account__c', createable: true, updateable: true, required: true, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.BOOLEAN, salesforceLabel: 'Top Account', externalId: false })
    public topAccount?: boolean | null;
    @sField({ apiName: 'Number_Of_Contacts__c', createable: true, updateable: true, required: false, reference: undefined, childRelationship: false, salesforceType: SalesforceFieldType.DOUBLE, salesforceLabel: 'Number Of Contacts', externalId: false })
    ...
    constructor(fields?: AccountFields, restInstance?: Rest) {
        ...
        this.dataQualityDescription = void 0;
        this.dataQualityScore = void 0;
        this.sumOfOpportunities = void 0;
        this.potentialValue = void 0;
        this.matchBillingAddress = void 0;
        this.firstName = void 0;
        this.foundingDate = void 0;
        this.lastName = void 0;
        this.topAccount = void 0;
        this.numberOfContacts = void 0;
